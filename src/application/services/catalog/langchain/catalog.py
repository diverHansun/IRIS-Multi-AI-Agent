"""
LangChain catalog service implementation.
"""
...
class LangChainCatalogService(BaseCatalogService):
    """
    Provide catalog data for LangChain providers and models.
    """
        ...
        try:
            ...
            if not available_agents:
                return {
                    ...
                    "message": "Please configure at least one API key (e.g. ZHIPU_API_KEY or OPENAI_API_KEY).",
                }
            ...
            return {"error": "Failed to get LLM catalog.", "message": str(exc)}
